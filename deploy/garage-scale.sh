...
: "${FJORD_GARAGE_SCALE_FLUSH_INFLIGHT:=4}"
: "${FJORD_GARAGE_SCALE_FLUSH_MAX_BUFFERED_BYTES:=536870912}"
...

{
  ...
  echo "flush_inflight=$FJORD_GARAGE_SCALE_FLUSH_INFLIGHT"
  echo "flush_max_buffered_bytes=$FJORD_GARAGE_SCALE_FLUSH_MAX_BUFFERED_BYTES"
...
nice -n "$FJORD_GARAGE_SCALE_NICE" env \
  ...
  FJORD_DURABLE_FLUSH_MAX_INFLIGHT="$FJORD_GARAGE_SCALE_FLUSH_INFLIGHT" \
  FJORD_DURABLE_FLUSH_MAX_BUFFERED_BYTES="$FJORD_GARAGE_SCALE_FLUSH_MAX_BUFFERED_BYTES" \
